...
//Es la funcion principal en donde llamaremos a la funcion sumaSucesiva
int main() {
    ...
    //se llama la funcio sumaSucesiva y le pasamos como parametro las variables donde estan almacenadas los datos introducidos por el usuario
    sumaSucesiva(n1,n2);
...
int sumaSucesiva(int numero1,int numero2){
	...
	for(i; i<=numero2; i++){
		//producto cada vez que pase el ciclo en 1 a producto se le va a sumar el primer parametro hasta terminar el ciclo
